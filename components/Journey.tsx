    ...
    <section className="py-24 bg-white overflow-hidden">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative max-w-5xl mx-auto">
             {/* Central Line */}
             <div className="journey-line absolute left-6 md:left-1/2 top-0 bottom-0 w-px bg-zinc-200 transform md:-translate-x-1/2"></div>
             ...
             <div className="space-y-12">
                {content.steps.map((step, index) => (
                    <div key={index} className={`relative flex flex-col md:flex-row items-center w-full ${index % 2 === 0 ? 'md:flex-row-reverse' : ''}`}>
                        ...
                        {/* Center Icon */}
                        <div className="journey-marker absolute left-6 md:left-1/2 transform -translate-x-1/2 z-10">
                        ...
                        {/* Content Card */}
                        <div className="journey-content flex-1 w-full pl-20 md:pl-0">
